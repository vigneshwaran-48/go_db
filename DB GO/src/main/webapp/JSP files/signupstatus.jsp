...
<body>
  ...
  <section class="full-login-wrapper y-axis-flex">
    ...
    <%
    	String isUserNameAvailable = (String) request.getAttribute("isUserNameAvailable");
    	if(isUserNameAvailable.equals("success")){
    		out.println("<h1 class='success-login'>SignUp Successful</h1>");
    	}
    	else{
    		out.println("<h1 class='failure-login'>SignUp Unsuccessful</h1>");
    		out.println("<h2 style='text-align:center;'>User name not available</h2>");
    	}
    %>  
    </div>
    <%
